> **Unsigned builds.** Apple Silicon (`arm64`) and Intel (`x64`) macOS builds.
> Neither is signed with an Apple Developer ID or notarized, so on first launch
> macOS Gatekeeper reports the app as **"HyppoVisor is damaged and can't be
> opened"** (misleading — the app is fine) and right-click → **Open** does *not*
> clear it.
>
